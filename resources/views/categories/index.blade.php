<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <!-- Tombol Tambah (contoh) -->
            <a href="{{ route('categories.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-semibold shadow hover:bg-blue-700 transition">
                + Tambah Kategori
            </a>
        </div>
    </x-slot>
